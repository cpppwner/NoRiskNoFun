...
public class Assets {
    ...
    public static final FontDescriptor LABEL_FONT_DESCRIPTOR = new FontDescriptor.Builder()
            .setFontFilename(DEFAULT_FONT_FILENAME)
            .setFontSize(110)
            .setForegroundColor(Color.WHITE)
            .setBorderWidth(2.0f)
            .build();
    public static final FontDescriptor BUTTON_FONT_DESCRIPTOR = new FontDescriptor.Builder()
            .setFontFilename(DEFAULT_FONT_FILENAME)
            .setFontSize(36)
            .setForegroundColor(Color.BLACK)
            .setBorderWidth(0.0f)
            .build();
    public static final FontDescriptor GAME_SCENE_LABEL_FONT_DESCRIPTOR = new FontDescriptor.Builder()
            .setFontFilename(DEFAULT_FONT_FILENAME)
            .setFontSize(36)
            .setForegroundColor(Color.WHITE)
            .setBorderWidth(2.0f)
    ...
    public static final TextButtonDescriptor DEFAULT_TEXT_BUTTON_DESCRIPTOR = new TextButtonDescriptor.Builder()
            .setTextButtonFont(BUTTON_FONT_DESCRIPTOR)
